...
def parse_option():
    ...
    parser.add_argument('--target_type', type=str, default='armored', choices=['armored', 'tank'], help='Target type')
    ...
    parser.add_argument('--IS_adjust_lr', type=bool, default=False, help='Whether to adjust learning rate')
