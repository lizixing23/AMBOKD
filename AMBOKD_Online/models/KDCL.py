...
class KDCL(nn.Module):
    def __init__(self, num_classes=2):
        ...
        self.KDCL_weight = Parameter(torch.ones(2),requires_grad=True)
    ...
    def KDCL(self,pic_classes,eeg_classes):
        KDCL_weight = F.softmax(self.KDCL_weight,0).to(DEVICE)
        KDCL_classes = KDCL_weight[0]*pic_classes+KDCL_weight[1]*eeg_classes
        return KDCL_classes
